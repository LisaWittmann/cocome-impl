...
namespace CocomeTest
{
    ...
    internal class StoreTest
    {
        ...
        public StoreTest(IModelMapper mapper)
        {
            ...
            mockContext.Setup(m => m.Stores).Returns(mockSet.Object);
            ...
            service = new StoreService(mockContext.Object, mapper);
        }
