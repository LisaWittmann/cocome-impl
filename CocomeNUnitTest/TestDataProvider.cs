...
namespace Cocome.NUnitTest
{
    ...
    internal class TestDataProvider
    {
        ...
        public TestDataProvider()
        {
            ...
            {
                new OrderTO() { Id = 1, Closed=false, Store=_store[0], PlacingDate=System.DateTime.Today.AddDays(-1), Provider=_provider[0]},
                new OrderTO() { Id = 2, Closed=false, Store=_store[0], PlacingDate=System.DateTime.Today.AddDays(-2), Provider=_provider[1]},
                new OrderTO() { Id = 3, Closed=true, Store=_store[0], PlacingDate=System.DateTime.Today.AddDays(-3), Provider=_provider[0], DeliveringDate= System.DateTime.Today.AddDays(-2)},
            };
